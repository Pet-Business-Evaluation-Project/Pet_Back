...
class MemberMypageTest {
    ...
    void setUp() {
        ...
        memberMypageService = new MemberMypageService(userRepository, memberRepository, reviewerRepository);
    ...
    void testGetMemberMypageInfo_Success() {
        ...
        when(memberRepository.findByUserUserId(1)).thenReturn(Optional.of(member));
